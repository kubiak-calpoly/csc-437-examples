...
export class BlzAccommodationElement extends HTMLElement {
  ...
  constructor() {
    super();
    shadow(this).template(BlzAccommodationElement.template)
      .styles(reset.styles, icon.styles,
        BlzAccommodationElement.styles);
  }
