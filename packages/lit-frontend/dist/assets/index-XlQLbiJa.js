 ...
 */
const t$2 = globalThis, e$3 = t$2.ShadowRoot && (void 0 === t$2.ShadyCSS || t$2.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, s$4 = Symbol(), o$3 = /* @__PURE__ */ new WeakMap();
let n$4 = class n {
  ...
  get styleSheet() {
    ...
    if (e$3 && void 0 === t2) {
      ...
      e2 && (t2 = o$3.get(s4)), void 0 === t2 && ((this.o = t2 = new CSSStyleSheet()).replaceSync(this.cssText), e2 && o$3.set(s4, t2));
    }
    return t2;
  }
  toString() {
...
const r$5 = (t2) => new n$4("string" == typeof t2 ? t2 : t2 + "", void 0, s$4), i$3 = (t2, ...e2) => {
  ...
  if (e$3)
    ...
    for (const e2 of o2) {
      ...
      void 0 !== n3 && o3.setAttribute("nonce", n3), o3.textContent = e2.cssText, s4.appendChild(o3);
    }
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: i$2, defineProperty: e$2, getOwnPropertyDescriptor: r$4, getOwnPropertyNames: h$1, getOwnPropertySymbols: o$2, getPrototypeOf: n$3 } = Object, a$1 = globalThis, c$1 = a$1.trustedTypes, l$1 = c$1 ? c$1.emptyScript : "", p$1 = a$1.reactiveElementPolyfillSupport, d$1 = (t2, s4) => t2, u$1 = { toAttribute(t2, s4) {
  switch (s4) {
    case Boolean:
      t2 = t2 ? l$1 : null;
      break;
  ...
  return i2;
} }, f$1 = (t2, s4) => !i$2(t2, s4), y$1 = { attribute: true, type: String, converter: u$1, reflect: false, hasChanged: f$1 };
...
class b extends HTMLElement {
  ...
  static createProperty(t2, s4 = y$1) {
    if (s4.state && (s4.attribute = false), this._$Ei(), this.elementProperties.set(t2, s4), !s4.noAccessor) {
      const i2 = Symbol(), r2 = this.getPropertyDescriptor(t2, i2, s4);
      void 0 !== r2 && e$2(this.prototype, t2, r2);
    }
  }
  static getPropertyDescriptor(t2, s4, i2) {
    ...
    return { get() {
      ...
      h2.call(this, s5), this.requestUpdate(t2, r2, i2);
  ...
  static finalize() {
    ...
    if (this.finalized = true, this._$Ei(), this.hasOwnProperty(d$1("properties"))) {
      const t3 = this.properties, s4 = [...h$1(t3), ...o$2(t3)];
      for (const i2 of s4)
  ...
  static finalizeStyles(s4) {
    ...
    if (Array.isArray(s4)) {
      ...
      void 0 !== s4 && i2.push(c$2(s4));
    return i2;
  }
  static _$Eu(t2, s4) {
    const i2 = s4.attribute;
  ...
  attributeChangedCallback(t2, s4, i2) {
    this._$AK(t2, i2);
  }
  _$EC(t2, s4) {
    var _a2;
    ...
    if (void 0 !== e2 && true === i2.reflect) {
      const r2 = (void 0 !== ((_a2 = i2.converter) == null ? void 0 : _a2.toAttribute) ? i2.converter : u$1).toAttribute(s4, i2.type);
  ...
  requestUpdate(t2, s4, i2) {
    if (void 0 !== t2) {
      if (i2 ?? (i2 = this.constructor.getPropertyOptions(t2)), !(i2.hasChanged ?? f$1)(this[t2], s4))
        return;
      this.P(t2, s4, i2);
    }
  ...
  P(t2, s4, i2) {
    this._$AL.has(t2) || this._$AL.set(t2, s4), true === i2.reflect && this._$Em !== t2 && (this._$Ej ?? (this._$Ej = /* @__PURE__ */ new Set())).add(t2);
  }
  async _$ET() {
  ...
  performUpdate() {
    ...
    if (!this.hasUpdated) {
      ...
      if (t3.size > 0)
        for (const [s5, i2] of t3)
          true !== i2.wrapped || this._$AL.has(s5) || void 0 === this[s5] || this.P(s5, this[s5], i2);
    }
    let t2 = false;
    const s4 = this._$AL;
    try {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const t$1 = globalThis, i$1 = t$1.trustedTypes, s$3 = i$1 ? i$1.createPolicy("lit-html", { createHTML: (t2) => t2 }) : void 0, e$1 = "$lit$", h = `lit$${(Math.random() + "").slice(9)}$`, o$1 = "?" + h, n$2 = `<${o$1}>`, r$3 = document, l = () => r$3.createComment(""), c = (t2) => null === t2 || "object" != typeof t2 && "function" != typeof t2, a = Array.isArray, u = (t2) => a(t2) || "function" == typeof (t2 == null ? void 0 : t2[Symbol.iterator]), d = "[ 	\n\f\r]", f = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, v = /-->/g, _ = />/g, m = RegExp(`>|${d}(?:([^\\s"'>=/]+)(${d}*=${d}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), p = /'/g, g = /"/g, $ = /^(?:script|style|textarea|title)$/i, y = (t2) => (i2, ...s4) => ({ _$litType$: t2, strings: i2, values: s4 }), x = y(1), w = Symbol.for("lit-noChange"), T = Symbol.for("lit-nothing"), A = /* @__PURE__ */ new WeakMap(), E = r$3.createTreeWalker(r$3, 129);
function C(t2, i2) {
...
const P = (t2, i2) => {
  ...
  for (let i3 = 0; i3 < s4; i3++) {
    ...
    l2 += c2 === f ? s5 + n$2 : d2 >= 0 ? (o2.push(a2), s5.slice(0, d2) + e$1 + s5.slice(d2) + h + x2) : s5 + h + (-2 === d2 ? i3 : x2);
  }
  return [C(t2, l2 + (t2[s4] || "<?>") + (2 === i2 ? "</svg>" : "")), o2];
};
class V {
  constructor({ strings: t2, _$litType$: s4 }, n3) {
    ...
    this.parts = [];
    let c2 = 0, a2 = 0;
    const u2 = t2.length - 1, d2 = this.parts, [f2, v2] = P(t2, s4);
    if (this.el = V.createElement(f2, n3), E.currentNode = this.el.content, 2 === s4) {
      ...
      if (1 === r2.nodeType) {
        if (r2.hasAttributes())
          for (const t3 of r2.getAttributeNames())
            if (t3.endsWith(e$1)) {
              const i2 = v2[a2++], s5 = r2.getAttribute(t3).split(h), e2 = /([.?@])?(.*)/.exec(i2);
              d2.push({ type: 1, index: c2, name: e2[2], strings: s5, ctor: "." === e2[1] ? k : "?" === e2[1] ? H : "@" === e2[1] ? I : R }), r2.removeAttribute(t3);
            } else
              t3.startsWith(h) && (d2.push({ type: 6, index: c2 }), r2.removeAttribute(t3));
        if ($.test(r2.tagName)) {
          const t3 = r2.textContent.split(h), s5 = t3.length - 1;
          if (s5 > 0) {
...
function N(t2, i2, s4 = t2, e2) {
  var _a2, _b;
  if (i2 === w)
    return i2;
  let h2 = void 0 !== e2 ? (_a2 = s4._$Co) == null ? void 0 : _a2[e2] : s4._$Cl;
  const o2 = c(i2) ? void 0 : i2._$litDirective$;
  return (h2 == null ? void 0 : h2.constructor) !== o2 && ((_b = h2 == null ? void 0 : h2._$AO) == null ? void 0 : _b.call(h2, false), void 0 === o2 ? h2 = void 0 : (h2 = new o2(t2), h2._$AT(t2, s4, e2)), void 0 !== e2 ? (s4._$Co ?? (s4._$Co = []))[e2] = h2 : s4._$Cl = h2), void 0 !== h2 && (i2 = N(t2, h2._$AS(t2, i2.values), h2, e2)), i2;
}
class S {
  constructor(t2, i2) {
  ...
  u(t2) {
    const { el: { content: i2 }, parts: s4 } = this._$AD, e2 = ((t2 == null ? void 0 : t2.creationScope) ?? r$3).importNode(i2, true);
    E.currentNode = e2;
    let h2 = E.nextNode(), o2 = 0, n3 = 0, l2 = s4[0];
    for (; void 0 !== l2; ) {
      if (o2 === l2.index) {
        let i3;
        2 === l2.type ? i3 = new M(h2, h2.nextSibling, this, t2) : 1 === l2.type ? i3 = new l2.ctor(h2, l2.name, l2.strings, this, t2) : 6 === l2.type && (i3 = new L(h2, this, t2)), this._$AV.push(i3), l2 = s4[++n3];
      }
  ...
  p(t2) {
    ...
    for (const s4 of this._$AV)
      void 0 !== s4 && (void 0 !== s4.strings ? (s4._$AI(t2, s4, i2), i2 += s4.strings.length - 2) : s4._$AI(t2[i2])), i2++;
  }
}
class M {
  get _$AU() {
  ...
  constructor(t2, i2, s4, e2) {
    this.type = 2, this._$AH = T, this._$AN = void 0, this._$AA = t2, this._$AB = i2, this._$AM = s4, this.options = e2, this._$Cv = (e2 == null ? void 0 : e2.isConnected) ?? true;
  }
  get parentNode() {
  ...
  $(t2) {
    var _a2;
    const { values: i2, _$litType$: s4 } = t2, e2 = "number" == typeof s4 ? this._$AC(t2) : (void 0 === s4.el && (s4.el = V.createElement(C(s4.h, s4.h[0]), this.options)), s4);
    if (((_a2 = this._$AH) == null ? void 0 : _a2._$AD) === e2)
      this._$AH.p(i2);
    else {
      const t3 = new S(e2, this), s5 = t3.u(this.options);
      t3.p(i2), this.T(s5), this._$AH = t3;
    }
  }
  _$AC(t2) {
  ...
  k(t2) {
    ...
    let s4, e2 = 0;
    for (const h2 of t2)
      e2 === i2.length ? i2.push(s4 = new M(this.S(l()), this.S(l()), this, this.options)) : s4 = i2[e2], s4._$AI(h2), e2++;
    e2 < i2.length && (this._$AR(s4 && s4._$AB.nextSibling, e2), i2.length = e2);
  }
...
class R {
  ...
  constructor(t2, i2, s4, e2, h2) {
    this.type = 1, this._$AH = T, this._$AN = void 0, this.element = t2, this.name = i2, this._$AM = e2, this.options = h2, s4.length > 2 || "" !== s4[0] || "" !== s4[1] ? (this._$AH = Array(s4.length - 1).fill(new String()), this.strings = s4) : this._$AH = T;
  }
  _$AI(t2, i2 = this, s4, e2) {
    ...
    if (void 0 === h2)
      ...
      for (t2 = h2[0], n3 = 0; n3 < h2.length - 1; n3++)
        r2 = N(this, e3[s4 + n3], i2, n3), r2 === w && (r2 = this._$AH[n3]), o2 || (o2 = !c(r2) || r2 !== this._$AH[n3]), r2 === T ? t2 = T : t2 !== T && (t2 += (r2 ?? "") + h2[n3 + 1]), this._$AH[n3] = r2;
    }
    o2 && !e2 && this.j(t2);
  }
  j(t2) {
...
class I extends R {
  constructor(t2, i2, s4, e2, h2) {
    super(t2, i2, s4, e2, h2), this.type = 5;
  }
  _$AI(t2, i2 = this) {
    if ((t2 = N(this, t2, i2, 0) ?? T) === w)
      return;
    const s4 = this._$AH, e2 = t2 === T && s4 !== T || t2.capture !== s4.capture || t2.once !== s4.once || t2.passive !== s4.passive, h2 = t2 !== T && (s4 === T || e2);
    e2 && this.element.removeEventListener(this.name, this, s4), h2 && this.element.addEventListener(this.name, this, t2), this._$AH = t2;
  }
  handleEvent(t2) {
    var _a2;
...
class L {
  constructor(t2, i2, s4) {
    this.element = t2, this.type = 6, this._$AN = void 0, this._$AM = i2, this.options = s4;
  }
  get _$AU() {
    return this._$AM._$AU;
  }
...
const j = (t2, i2, s4) => {
  const e2 = (s4 == null ? void 0 : s4.renderBefore) ?? i2;
  let h2 = e2._$litPart$;
  if (void 0 === h2) {
    const t3 = (s4 == null ? void 0 : s4.renderBefore) ?? null;
    e2._$litPart$ = h2 = new M(i2.insertBefore(l(), t3), t3, void 0, s4 ?? {});
  }
...
r$2 == null ? void 0 : r$2({ LitElement: s$2 });
...
const o = { attribute: true, type: String, converter: u$1, reflect: false, hasChanged: f$1 }, r$1 = (t2 = o, e2, r2) => {
  ...
  let s4 = globalThis.litPropertyMetadata.get(i2);
  if (void 0 === s4 && globalThis.litPropertyMetadata.set(i2, s4 = /* @__PURE__ */ new Map()), s4.set(r2.name, t2), "accessor" === n3) {
    const { name: o2 } = r2;
    return { set(r3) {
...
function closestElement(selector, el) {
  return el && el !== document.rootElement && (el.closest(selector) || el.shadowRoot && closestElement(selector, el.shadowRoot.host)) || void 0;
}
function whenObservableFrom(consumer, context) {
...
class ObservableElement extends s$2 {
  constructor(init2) {
    super();
    console.log("Constructing observable", this);
    this.subject = createObservable(init2, this);
  }
  attach(observer) {
...
class ContextObserver {
  ...
  observe() {
    return new Promise((resolve, reject) => {
      if (this._observable) {
        const observer = new Observer(this._observable);
        this._observers.push(observer);
        resolve(observer);
      } else {
        whenObservableFrom(this._target, this._context).then(
          (oe) => {
            const observer = new Observer(oe);
            this._observable = oe;
            this._observers.push(observer);
            oe.attach(
...
class AuthenticatedUser extends APIUser {
  ...
  static authenticateFromLocalStorage(signOut) {
    ...
    return priorToken ? AuthenticatedUser.authenticate(priorToken, signOut) : new APIUser();
  }
}
const _Auth = class _Auth extends ObservableElement {
  constructor() {
    super({
...
__decorateClass$f([
  r()
], Auth.prototype, "loginStatus", 2);
__decorateClass$f([
  r()
], Auth.prototype, "registerStatus", 2);
function define(defns) {
  Object.entries(defns).map(
    ([k2, v2]) => customElements.define(k2, v2)
  );
}
/**
 * @license
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
let s$1 = class s2 extends Event {
  constructor(s4, t2, e2) {
    super("context-request", { bubbles: true, composed: true }), this.context = s4, this.callback = t2, this.subscribe = e2 ?? false;
  }
};
/**
 * @license
...
class i extends s3 {
  constructor(s4, e2, i2) {
    ...
    super(void 0 !== e2.context ? e2.initialValue : i2), this.onContextRequest = (t2) => {
      ...
      const e3 = s5.composedPath()[0];
      if (s5.context !== this.context || e3 === this.host)
        return;
      const i3 = /* @__PURE__ */ new Set();
      for (const [s6, { consumerHost: e4 }] of this.subscriptions)
        i3.has(s6) || (i3.add(s6), e4.dispatchEvent(new s$1(this.context, s6, true)));
      s5.stopPropagation();
    }, this.host = s4, void 0 !== e2.context ? this.context = e2.context : this.context = e2, this.attachListeners(), (_b = (_a2 = this.host).addController) == null ? void 0 : _b.call(_a2, this);
  }
  attachListeners() {
...
let historyContext = n2("auth");
class History extends s$2 {
  constructor() {
    super();
    this._historyProvider = new i(this, {
...
let Router$1 = class Router extends Resolver {
  /**
...
usageStatistics();
Router$1.NavigationTrigger = { POPSTATE, CLICK };
class Router2 extends s$2 {
  constructor(routes2) {
    super();
    this.router = new Router$1(this);
    this._routes = routes2;
  }
  connectedCallback() {
...
function getModelProvider(el) {
  const provider = el.closest(
    "[data-store-context]"
  );
  return provider;
}
class ModelProvider extends s$2 {
  constructor(init2) {
    super();
    this._context = n2("mu:Store");
    this.dataset.storeContext = "mu:Store";
    this._modelProvider = new i(this, {
  ...
  get model() {
    var _a2;
    return (_a2 = this._modelProvider) == null ? void 0 : _a2.value;
  }
}
class Store extends ModelProvider {
  constructor(update2, init2) {
    super(init2);
      ...
      if (typeof (promise == null ? void 0 : promise.then) === "function") {
        promise.then((mapFn) => {
          if (this.model && this._modelProvider) {
            const next2 = mapFn(this.model);
            console.log("Updating model in Promise:", next2);
            this._modelProvider.setValue(next2);
          }
        });
      } else {
...
function noUpdate(m2) {
  return m2;
}
class View extends s$2 {
  connectedCallback() {
    super.connectedCallback();
    const provider = getModelProvider(this);
    this._model = provider == null ? void 0 : provider.model;
  }
  ...
  getFromModel(key) {
    return this._model ? this._model[key] : void 0;
  }
}
const init = {
  user: new APIUser()
...
function parseUTCDate(s4) {
  const date = new Date(Date.parse(s4));
  const d2 = date.getUTCDate();
...
let CalendarWidget = class extends s$2 {
  constructor() {
    super(...arguments);
...
let EntourageTable = class extends s$2 {
  get entourage() {
    return this.using || {};
  }
  render() {
...
let ItineraryItemElement = class extends s$2 {
  constructor() {
    super(...arguments);
...
let TourPageElement = class extends View {
  get tourId() {
    var _a2;
...
let UserProfileElement = class extends View {
  get profile() {
    return this.using || {};
  }
  render() {
  ...
  _handleSubmit(event) {
    ...
    if (this.profile) {
      ...
      let entries = Array.from(formdata.entries()).map(([k2, v2]) => v2 === "" ? [k2] : [k2, v2]).map(
        ([k2, v2]) => k2 === "airports" ? [k2, v2.split(",").map((s4) => s4.trim())] : [k2, v2]
      );
      if (this.newAvatar)
...
let ProfilePageElement = class extends View {
  get userid() {
    var _a2;
...
let ExcursionCardElement = class extends s$2 {
  render() {
    return x`
      <div class="card">
        <svg class="icon">
...
ExcursionCardElement = __decorateClass$8([
  t("excursion-card")
...
let DestinationPageElement = class extends View {
  constructor() {
    var _a2;
    super(...arguments);
...
DestinationPageElement = __decorateClass$7([
  t("destination-page")
...
let ChatRoomElement = class extends View {
  constructor() {
    super(...arguments);
    this.messages = [];
  }
...
ChatRoomElement = __decorateClass$6([
  t("chat-room")
], ChatRoomElement);
...
let EntouragePageElement = class extends View {
  get tourId() {
    var _a2;
    return (_a2 = this.location) == null ? void 0 : _a2.params.tour;
  }
...
EntouragePageElement = __decorateClass$5([
  t("entourage-page")
...
let DropDownElement = class extends s$2 {
  constructor() {
    super(...arguments);
    this.open = false;
    this.align = "left";
...
let ToggleSwitchElement = class extends s$2 {
  constructor() {
    super(...arguments);
    this.on = false;
  }
...
ToggleSwitchElement = __decorateClass$3([
  t("toggle-switch")
], ToggleSwitchElement);
...
let PresetButtonsElement = class extends s$2 {
  constructor() {
    super(...arguments);
    this.name = "preset";
...
PresetButtonsElement = __decorateClass$2([
  t("preset-buttons")
...
let UserPanelElement = class extends s$2 {
  constructor() {
    super(...arguments);
    this.avatar = "";
  }
...
UserPanelElement = __decorateClass$1([
  t("user-panel")
], UserPanelElement);
...
const _BlazingHeaderElement = class _BlazingHeaderElement extends s$2 {
  constructor() {
    super(...arguments);
    this.user = new APIUser();
    this._authObserver = new ContextObserver(
      this,
      "blazing:auth"
    );
  }
...
let BlazingHeaderElement = _BlazingHeaderElement;
__decorateClass([
  r()
...
define({
  "mu-history": History,
  "mu-auth": Auth,
  "mu-store": class AppStore extends Store {
    constructor() {
      super(update, init);
    }
  },
  "mu-router": class AppRouter extends Router2 {
    constructor() {
      super(routes);
    }
  },
