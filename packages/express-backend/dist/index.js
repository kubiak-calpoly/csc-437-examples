...
app.get("/profile/:userid", (req, res) => {
  ...
  const profile = userid ? import_profiles.default.get(userid) : void 0;
  if (profile) {
    res.set("Content-Type", "text/html").send((0, import_pageTemplate.default)({ body: (0, import_profileView.default)(profile) }));
  } else {
    res.status(404).end();
  }
});
